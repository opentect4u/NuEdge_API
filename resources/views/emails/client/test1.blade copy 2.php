...
<body>
    ...
    <div class="border w-full mx-2 my-2">
        <div class="border-bottom w-full " style="background-color: rgba(20, 214, 240, 0.014);display:flex">
        ...
        <div class="p-2">
            <table style="font-family: arial, sans-serif;border-collapse: collapse;width: 100%;">
                <thead>
                    <tr style="background-color: #0a6494;color:#fff">
                        <th
                            style="border: 1px solid #0a649471;text-align: center;padding: 2px;font-size:15px;font-weight:500;width:150px">
                            Scheme</th>
                        <th style="border: 1px solid #0a649471;text-align: center;padding: 2px;font-weight:500">
                            Inv. Since</th>
                        <th style="border: 1px solid #0a649471;text-align: center;padding: 2px;font-weight:500">
                            SENSEX</th>
                        <th style="border: 1px solid #0a649471;text-align: center;padding: 2px;font-weight:500">
            ...
            @for($i=0;$i<=2;$i++) <table style="font-family: arial, sans-serif;border-collapse: collapse;width: 100%;">
                <tbody>
                    <tr>
                        <td
                ...
                <table style="width:100%!important">
                    <thead>
                        <tr style="background-color: #0284c7;color:#fff">
                            <th style="border: 1px solid #0285c7ab;text-align: center;padding: 2px;font-size:9px">
                                Sl No</th>
                            <th style="border: 1px solid #0285c7ab;text-align: center;padding: 2px;font-size:9px">
                                Trans Type</th>
                            <th style="border: 1px solid #0285c7ab;text-align: center;padding: 2px;font-size:9px">
