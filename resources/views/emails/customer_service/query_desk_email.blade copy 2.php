                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td height="22"
                                                    ...
                                                    <b style="color:#4169E1;">{{$query_status}}</b> Please do not reply
                                                    to this
                                                    email<br><br>Request you to
                                                    kindly check reply description in below Status. If you find the
                                                    reply irrelevant
                                                    to you, you can <a href="#" target="_blank">reopen</a> this query OR
                                                    email us at<a href="mailto:service@nuedgecorporate.co.in"
                                                        target="_blank">
                                    ...
                                    <table cellpadding="0 " cellspacing="0 " style="width:100%">
                                        <tbody>
                                            ...
                                            <tr style="background:#f6f6f6">
                                                ...
                                                <td
                                                    style="width:34%;color:#000;font-size:14px;text-align:left;font-family:'calibri','Segoe UI','Helvetica Neue',Helvetica,Arial,sans-serif;padding:6px 0 6px 10px;border-right:1px solid #ddd;border-bottom:1px solid #ddd">
                                                    {{isset($data->expected_close_date)?date('d-m-Y',strtotime($data->expected_close_date)):date('d-m-Y',strtotime(date('Y-m-d',
                                       strtotime($data->date_time. ' + '.$data->query_tat.' day'))))}}
                                                ...
                                                <td
                                                    ...
                                                    $actual_close_date =
                                                    strtotime(date('y-m-d',strtotime($data->actual_close_date)));
                                                    $expected_close_date = strtotime($data->expected_close_date);
                                                    $isExpired =($expected_close_date < $actual_close_date)?'Yes':'No';
                                                        // return $isExpired; }else{ if($data->expected_close_date){
                                                        $expected_close_date = strtotime($data->expected_close_date);
                                                        $today=strtotime(date('Y-m-d'));
                                                        $isExpired =($expected_close_date < $today)?'Yes':'No'; } else{
                                                            $cal_date=date('Y-m-d', strtotime($data->date_time. ' +
                                                            '.$data->query_tat.' day'));
                                                            $new_date = \Carbon\Carbon::create($cal_date);
                                                            $isAfter =
                                                            \Carbon\Carbon::create(date('Y-m-d'))->diffInDays($new_date);
                                                            $isExpired = ($isAfter <= 0) ?'Yes':'No'; } } echo
                                                                $isExpired; } @endphp </td>
                                            </tr>
                                            <tr>
                                                <td valign="top"
                                            ...
                                            <tr style="background:#f6f6f6">
                                                ...
                                                <td colspan="3"
                                                    ...
                                                    <a
                                                        href="{{env('QUERY_DOWNLOAD_LINK').Crypt::encrypt($attachment->id)}}">Click
                                                        Here to download attachment {{($key+1)}}</a>
                                                    {{-- <a href="{{asset('public/query-attachment/'.$attachment->name)}}"
                                                    download="{{$attachment->name}}">Click Here to download attachment
                                                    {{($key+1)}}</a> --}}
                                                    </br>
                                                    @endforeach
                                                    @else
                        ...
                        <tbody>
                            <tr>
                                ...
                                border-right:1px solid #ddd;border-bottom:1px solid #ddd;border-left:1px solid #ddd;border-top:1px solid #ddd">
                                                    ...
                                                    {{-- <img src="{{asset('public/feedback.gif')}}" alt="" srcset=""
                                                    width="100px" height="70px"> --}}

                                                    <div class="animatedBtn">
                                                        <p class="queryBtn p-button-rounded color-2">Feedback</p>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width:33.33%;border-right:1px solid #ccc;text-align:center">
                                                    <p
                                                        ...
                                                        <span style="margin-top:15px">
                                                            <a href="https://bit.ly/NuEdgeClientDesk"
                                                            ...
                                                            <a href="https://bit.ly/NuEdgeClientDeskIOS"
                                                                style="text-decoration:none" target="_blank">
                                                                <img height="36"
                                                ...
                                                <td style="width:33.33%;">
                                                    <table style="text-align:center;width:100%" cellspacing="0 "
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td width="8%">
                                                                    <a href="https://www.facebook.com/nuedgecorporate"
                                                                        target="_blank">
                                                                ...
                                                                <td width="8%">
                                                                    <a href="https://www.linkedin.com/company/nuedge-corporate-private-limited"
                                                                        target="_blank">
                                                                        <img alt=" " height="30" width="30"
                                                                ...
                                                                <td width="8%">
                                                                    <a href="https://twitter.com/nuedgecorporate"
                                                                        target="_blank">
                                                                        <img alt=" " height="35"
                            ...
                            <tr>
                                <td
                                    ...
                                    <span
                                        ...
                                        <b style="color:#042db4;">NuEdge Corporate Private Limited <sup
                                                style="color:#042db4;font-size:13px;">®</sup></b><br>
                                        <b style="color:#042db4;">AMFI Registered Mutual Fund Distributor</b><br>
                                        1A, Dr Sarat Banerjee Road, <br>
                                        Opp-CESE Supply Office<br>
                                        Kolkata -700029. <br>
                                        E-mail: <a href="mailto:service@nuedgecorporate.co.in"
