                ...
                switch ($sip_type) {
                    ...
                    case 'R':
                        if ($sub_type=='RR') {
                            ...
                            //     OR 
                            //     datediff(DATE_FORMAT(tt_sip_stp_swp_report.cease_terminate_date,"Y-m-d"), DATE_FORMAT(tt_sip_stp_swp_report.from_date,"Y-m-d")) < 30
                            // )';
                        }
                        break;
                    case 'T':
                        ...
                        $rawQuery.=' AND DATE_FORMAT(tt_sip_stp_swp_report.from_date,"Y-m-d") <= DATE_FORMAT(tt_sip_stp_swp_report.cease_terminate_date,"Y-m-d")';
                        // $rawQuery.=' AND datediff(DATE_FORMAT(tt_sip_stp_swp_report.cease_terminate_date,"Y-m-d"), DATE_FORMAT(tt_sip_stp_swp_report.from_date,"Y-m-d")) > 30';
                        break;
                    case 'M':
                        if ($sub_type=='MM') {  
                            // $rawQuery.=' AND tt_sip_stp_swp_report.to_date <= "'.date('Y-m-d').'" ';
