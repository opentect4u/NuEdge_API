            ...
            if($request->temp_tin_no!='' && $request->tin_status=='Y'){  // with TTIN NO
                ...
                if (count($has)>0) {
                    ...
                    $data=MutualFund::create(array(
                        ...
                        'third_kyc'=>isset($request->third_client_kyc)?$request->third_client_kyc:NULL,
                        ...
                        'folio_no'=>isset($request->folio_no)?$request->folio_no:NULL,
                        'amount'=>(($request->amount)?$request->amount:(($request->redemp_amount)?$request->redemp_amount:(($request->swp_stp_amt)?$request->swp_stp_amt:(($request->swp_stp_amount)?$request->swp_stp_amount:0)))),
                        ...
                        'sip_swp_stp_duration_type'=>((isset($request->sip_duration_type))?$request->sip_duration_type:(($request->swp_stp_duration_type)?$request->swp_stp_duration_type:NULL)),
                        ...
                        'sip_swp_stp_inst_date'=>(($request->sip_date)?$request->sip_date:(($request->installment_dt)?$request->installment_dt:(($request->swp_stp_date)?$request->swp_stp_date:NULL))),
                        ...
                        'existing_bank_acc_no'=>isset($request->existing_bank_acc_no)?$request->existing_bank_acc_no:NULL,
                        'existing_acc_bank_id'=>isset($request->existing_acc_bank_id)?$request->existing_acc_bank_id:NULL,
                        ...
                        'second_client_kyc_status'=>isset($request->second_client_kyc_status)?$request->second_client_kyc_status:NULL,
                ...
                /**end 2nd holder client add  */
                /**start 3rd holder client add  */
                $third_client_id=$request->third_client_id;
                $third_client_name=$request->third_client_name;
                $third_client_pan=$request->third_client_pan;
