        ...
        try {
            ...
            if ($option==3) {
                ...
                //         ->join('md_client','md_client.id','=','td_form_received.client_id')
                        // ->leftJoin('md_branch','md_branch.id','=','td_kyc.branch_code')
                        // ->leftJoin('md_employee','md_employee.euin_no','=','td_kyc.euin_no')
                //         ->select('td_form_received.*','md_trans.trns_name as trans_name','md_trans.trans_type_id as trans_type_id','md_branch.brn_name as branch_name','md_trns_type.trns_type as trans_type','md_scheme.scheme_name as scheme_name','md_scheme_2.scheme_name as scheme_name_to','md_client.client_code as client_code','md_client.client_name as client_name','md_client.client_type as client_type')
