            ...
            if ($sip_type || $date_range || $folio_no || $pan_no || !empty($amc_id) || !empty($cat_id) || !empty($sub_cat_id) || !empty($scheme_id)) {
                switch ($sip_type) {
                    ...
                    case 'M':
                        ...
                        break;
                    case 'P':
                        $rawQuery.=' AND date(tt_sip_stp_swp_report.cease_terminate_date,"Y-m-d") IS NULL ';
                        $rawQuery.=' AND date(tt_sip_stp_swp_report.pause_from_date,"Y-m-d")!="" ';
                        $rawQuery.=' AND date(tt_sip_stp_swp_report.pause_to_date,"Y-m-d")!="" ';
                        $rawQuery.=' AND date(tt_sip_stp_swp_report.to_date,"Y-m-d") >="'.date('Y-m-d').'" ';
                        break;
                    default:
                        break;
                }
