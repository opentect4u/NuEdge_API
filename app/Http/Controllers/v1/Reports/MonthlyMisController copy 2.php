                ...
                switch ($view_by) {
                    ...
                    case 'Y':
                        ...
                        if ($period_type=='M') {
                            ...
                            $end_date = date('t',strtotime(explode('-',$fin_year)[1]."-03-01"))."-03-01";
                            if(strtotime($end_date) > strtotime(date('Y-m-d'))){
                                $end_date=date('Y-m-d');
                            }
                            // return $start_date."  -  ".$end_date;
                            ...
                            // $end_date='2023-05-01';
                            // $ex_fin_year=explode('-',$fin_year);
                            // return $ex_fin_year;
                            // return $fin_year[0]."  -  ".$fin_year[1];
                            // $lastday = date('t',strtotime(explode('-',$fin_year)[1]."-03-01"));
                            for ($i=0; $i <= 4; $i++) { 
                                if ($i==0) {
                                    ...
                                    $end_date=date('Y-m-t',strtotime(explode('-',$fin_year)[0]."-12-01"));
                                    $split_date="QTR-III";
                                }elseif($i==2) {
                                    $start_date=explode('-',$fin_year)[0]."-07-01";
                                    $end_date=date('Y-m-t',strtotime(explode('-',$fin_year)[0]."-09-01"));
                                    $split_date="QTR-II";
                                }elseif($i==3) {
                                    $start_date=explode('-',$fin_year)[0]."-04-01";
                                    $end_date=date('Y-m-t',strtotime(explode('-',$fin_year)[0]."-06-01"));
                                    $split_date="QTR-I";
                                }elseif($i==4) {
                                    $start_date=explode('-',$fin_year)[0]."-01-01";
                                    $end_date=date('Y-m-t',strtotime(explode('-',$fin_year)[0]."-03-01"));
                                    $split_date="PRV-QTR-IV";
                                }
                            ...
                            for ($i=0; $i <= 2; $i++) { 
                                if($i==0) {
                                    $start_date=explode('-',$fin_year)[0]."-10-01";
                                    $end_date=date('Y-m-t',strtotime(explode('-',$fin_year)[1]."-12-01"));
                                    $split_date="2nd-HALF";
                                }elseif($i==1) {
                                    $start_date=explode('-',$fin_year)[0]."-04-01";
                                    $end_date=date('Y-m-t',strtotime(explode('-',$fin_year)[0]."-09-01"));
