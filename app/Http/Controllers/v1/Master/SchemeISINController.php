    ...
    public function createUpdate(Request $request)
    {
        ...
        try {
            ...
            foreach ($isin_dtls as $key => $value) {
                ...
                //     }
                // }
                MutualFundTransaction::where('product_code',$value->product_code)->update([
                    'scheme_flag'=>'N',
                    'plan_option_flag'=>'N',
                ]);
                ...
                // Start insert and update scheme ISIN, update table td_broker_change_trans 
                BrokerChangeTrans::where('product_code',$value->product_code)->update([
                    'scheme_flag'=>'N',
                    'plan_option_flag'=>'N',
                ]);

                // Start insert and update scheme ISIN, update table td_folio_details 
                FolioDetails::where('product_code',$value->product_code)->update([
                    'scheme_flag'=>'N',
                    'plan_option_flag'=>'N',
                ]);
