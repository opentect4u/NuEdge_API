                ...
                if ($file_type_id=='1' && $file_id=='1') {  // transction  WBR2
                    ...
                    for ($i=$start_count; $i <= $end_count; $i++) { 
                        ...
                        $single_array=[
                            ...
                            'trans_date'=>Carbon::parse(explode("/",str_replace("'","",$value[11]))[1].'-'.explode("/",str_replace("'","",$value[11]))[0].'-'.explode("/",str_replace("'","",$value[11]))[2])->format('Y-m-d'),
                            'post_date'=>Carbon::parse(explode("/",str_replace("'","",$value[12]))[1].'-'.explode("/",str_replace("'","",$value[12]))[0].'-'.explode("/",str_replace("'","",$value[12]))[2])->format('Y-m-d'),
                            'pur_price'=>str_replace("'","",$value[13]),
                            'units'=>str_replace("'","",$value[14]),
                            'amount'=>str_replace("'","",$value[15]),
                            'rec_date'=>Carbon::parse(explode("/",str_replace("'","",$value[21]))[1].'-'.explode("/",str_replace("'","",$value[21]))[0].'-'.explode("/",str_replace("'","",$value[21]))[2])->format('Y-m-d'),
                    ...
                    for ($i=$start_count; $i <= $end_count; $i++) { 
                        ...
                        if (isset($value[1]) && isset($value[31]) && isset($value[47]) && isset($value[74])) {
                            ...
                            $single_array=[
                                ...
                                'tpin'=>NULL,
                                'f_name'=>NULL,
                                'dob'=>($mydob)?date('Y-m-d',strtotime($mydob)):NULL,
                                'dob_2nd_holder'=>($mydob2)?date('Y-m-d',strtotime($mydob2)):NULL,
                                'dob_3rd_holder'=>($mydob3)?date('Y-m-d',strtotime($mydob3)):NULL,
                                'm_name'=>NULL,
                                ...
                                'guardian_dob'=>($mydob4)?date('Y-m-d',strtotime($mydob4)):NULL,
                ...
                if ($file_type_id==1 && $file_id==5) {  // transction MFSD201
                    ...
                    for ($i=$start_count; $i <= $end_count; $i++) { 
                        ...
                        $single_array=[
                            ...
                            'trans_date'=>Carbon::parse(str_replace("/","-",$value[14]))->format('Y-m-d'),
                            'post_date'=>Carbon::parse(str_replace("/","-",$value[15]))->format('Y-m-d'),
                            'pur_price'=>$value[16],
                            'units'=>$value[17],
                            'amount'=>$value[18],
                            'rec_date'=>Carbon::parse(str_replace("/","-",$value[24]))->format('Y-m-d'),
