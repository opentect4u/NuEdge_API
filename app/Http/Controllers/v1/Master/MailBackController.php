                    ...
                    for ($i=$start_count; $i <= $end_count; $i++) { 
                        ...
                        if (isset($value[1]) && isset($value[31]) && isset($value[47]) && isset($value[74])) {
                            ...
                            TempFolioDetails::create(array(
                                ...
                                'amc_code'=>str_replace("'","",$value[0]),
                                'folio_no'=>str_replace("'","",$value[2]),
                                'folio_date'=>($folio_dt)?DATE_FORMAT($folio_dt,'Y-m-d H:i:s'):NULL,
                                ...
                                'tpin'=>NULL,
                                'f_name'=>NULL,
                                'dob'=>($mydob)?DATE_FORMAT($mydob,'Y-m-d'):NULL,
                                'dob_2nd_holder'=>($mydob2)?DATE_FORMAT($mydob2,'Y-m-d'):NULL,
                                'dob_3rd_holder'=>($mydob3)?DATE_FORMAT($mydob3,'Y-m-d'):NULL,
                                'm_name'=>NULL,
                                ...
                                'guardian_dob'=>($mydob4)?DATE_FORMAT($mydob4,'Y-m-d'):NULL,
