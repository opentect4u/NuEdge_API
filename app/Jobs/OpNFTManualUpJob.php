...
class OpNFTManualUpJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $all_data=MutualFund::join('md_client','md_client.id','=','td_mutual_fund.first_client_id')
            ...
            ->select('td_mutual_fund.id as id','td_mutual_fund.rnt_login_dt','td_mutual_fund.rnt_login_cutt_off','td_mutual_fund.trans_scheme_from',
